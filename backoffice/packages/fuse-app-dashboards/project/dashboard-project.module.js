(function() {
    ...
    function config($stateProvider, msApiProvider) {
        ...
        $stateProvider.state('app.dashboards_project', {
            ...
            views: {
                'content@app': {
                    templateUrl: 'client/main/apps/dashboards/project/dashboard-project.html',
        ...
        // Api
        msApiProvider.register('dashboard.project', ['client/data/dashboard/project/data.json']);
    }
