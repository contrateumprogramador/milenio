(function() {
    ...
    function config($stateProvider, msApiProvider) {
        ...
        $stateProvider.state('app.dashboards_analytics', {
            ...
            views: {
                'content@app': {
                    templateUrl: 'client/main/apps/dashboards/analytics/dashboard-analytics.html',
        ...
        // Api
        msApiProvider.register('dashboard.analytics', ['client/data/dashboard/analytics/data.json']);
    }
